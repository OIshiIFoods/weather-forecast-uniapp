...
export namespace Api {
    /** 获取当前的天气信息 */
    export namespace GetCurWeatherInfo {
        export type Request = {
            /** 纬度 */
            lat: number
            /** 经度 */
    ...
    /** 获取未来指定天数的天气信息 */
    export namespace GetMultDayWeatherInfo {
        export type Request = {
            /** 纬度 */
            lat: number
            /** 经度 */
    ...
    /** 获取未来数小时的天气信息 */
    export namespace GetHourlyWeatherInfo {
        export type Request = {
            /** 纬度 */
            lat: number
            /** 经度 */
    ...
    /** 获取当前空气质量 */
    export namespace GetCurAirQuality {
        export type Request = {
            /** 纬度 */
            lat: number
            /** 经度 */
    ...
    /** 获取未来5天的空气质量 */
    export namespace GetMultDayAirQuality {
        export type Request = {
            /** 纬度 */
            lat: number
            /** 经度 */
